...
import ExchangeSellerTwoPopUp from "./ExchangeSellerTwoPopUp";

const ExchangeSellerTwo = ({ card }) => {
  ...
  // 👇 Example value string for popup
  const popupValue = `${baseCurrency} 1.166  0.05%▼`;
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.left}>
        ...
        <p>
          Displays current exchange rate for selected currency and 7 days
          history chart.
        </p>
      </div>
            ...
            <div>
              ...
              <div style={styles.field}>
                ...
                <input
                  type="color"
                  value={divisorColor}
                  onChange={(e) => setDivisorColor(e.target.value)}
                />
              </div>
          ...
          {activeTab === "language" && (
            <div>
              <div style={styles.field}>
                ...
                <p>
                  These labels will be displayed in the app. You can override
                  them if needed.
                </p>
              </div>
              ...
              <div style={styles.field}>
                ...
                <input
                  type="text"
                  value={appLabels.exchangeRate}
                  onChange={(e) =>
                    setAppLabels({ ...appLabels, exchangeRate: e.target.value })
                  }
                  style={styles.input}
                />
              </div>
              ...
              <div style={styles.field}>
                ...
                <input
                  type="text"
                  value={appLabels.dailyVariation}
                  onChange={(e) =>
                    setAppLabels({ ...appLabels, dailyVariation: e.target.value })
                  }
                  style={styles.input}
                />
              </div>
              ...
              <div style={styles.field}>
                ...
                <input
                  type="text"
                  value={appLabels.weeklyVariation}
                  onChange={(e) =>
                    setAppLabels({ ...appLabels, weeklyVariation: e.target.value })
                  }
                  style={styles.input}
                />
              </div>
...
export default ExchangeSellerTwo;
