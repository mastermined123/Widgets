...
import ExchangeRateChartPopUp from "./ExchangeRateChartPopUp";

const ExchangeRateChartForm = ({ card }) => {
  ...
  const [spread, setSpread] = useState(""); // percentage (optional)
  const [headerText, setHeaderText] = useState("");
  const [showEachCurrencyFor, setShowEachCurrencyFor] = useState(""); // seconds (optional)
  const [headerTextColor, setHeaderTextColor] = useState(""); // optional
        ...
        <div style={styles.tabContent}>
          {activeTab === "settings" && (
            <div>
              ...
              <div style={styles.field}>
                <label>Show each currency for (seconds) (optional):</label>
                <input
                  type="number"
          ...
          {activeTab === "language" && (
            <div>
              ...
              <div style={styles.field}>
                <label style={{ fontWeight: "bold", marginBottom: "10px" }}>App Labels</label>
                <p style={styles.helpText}>
                ...
                {currencyOptions.map(currency => (
                  <div key={currency.code} style={styles.labelField}>
                    <input
                      type="text"
                      placeholder={currency.name}
                      value={currencyLabels[currency.code] || ""}
                      onChange={e => handleCurrencyLabelChange(currency.code, e.target.value)}
                      style={styles.input}
                    />
                  </div>
                ))}
...
export default ExchangeRateChartForm;