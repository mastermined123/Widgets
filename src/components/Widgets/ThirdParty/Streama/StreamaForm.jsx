...
import StreamaPopUp from "./StreamaPopUp";

function StreamaForm({ card }) {
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.left}>
        <label style={{ ...styles.field, fontWeight: "bold" }}>{card?.title || "Strea.ma"}</label>
        {card?.imageSrc && <img src={card.imageSrc} alt={card?.title || "Strea.ma"} style={styles.image} />}
        <p>Display your Strea.ma content with customizable settings.</p>
      </div>
      ...
      <div style={styles.right}>
        ...
        <div style={styles.tabContent}>
          <div>
            ...
            {/* Streama URL */}
            <div style={styles.field}>
              <label>Strea.ma URL</label>
              <input
                type="text"
                value={streamaUrl}
                onChange={(e) => setStreamaUrl(e.target.value)}
                style={styles.input}
                placeholder="Enter your Strea.ma URL"
              />
              <div style={styles.helperText}>
                You can get your Strea.ma URL by opening your created app, clicking "Get App", and copying the URL.
              </div>
            </div>
          </div>
        </div>
