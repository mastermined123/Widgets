...
function SmallWeatherAppLanguageForm({ card, onSwitchToSettings, appName, forecastLocation, backgroundColor, textColor, backgroundImage, textFont, language, setLanguage, languageLabels, setLanguageLabels, locationName, usePlayerLocation, temperatureScale, transitionInterval }) {
...
export default SmallWeatherAppLanguageForm;