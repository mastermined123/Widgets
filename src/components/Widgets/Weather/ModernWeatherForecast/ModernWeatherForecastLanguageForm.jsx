...
function ModernWeatherForecastLanguageForm({ card, onSwitchToSettings, appName, forecastLocation, backgroundColor, textColor, backgroundImage, textFont, language, setLanguage, languageLabels, setLanguageLabels }) {
...
export default ModernWeatherForecastLanguageForm;