...
import ModernWeatherForecastTallandBarForm from "./ModernWeatherForecastTallandBarForm";
import ModernWeatherForecastTallandBarLanguageForm from "./ModernWeatherForecastTallandBarLanguageForm";

function ModernWeatherForecastTallandBarMain({ card }) {
    ...
    return (
        <div style={styles.container}>
            {currentView === "settings" ? (
                <ModernWeatherForecastTallandBarForm 
                    card={card} 
                ...
                <ModernWeatherForecastTallandBarLanguageForm 
                    card={card} 
...
export default ModernWeatherForecastTallandBarMain;
