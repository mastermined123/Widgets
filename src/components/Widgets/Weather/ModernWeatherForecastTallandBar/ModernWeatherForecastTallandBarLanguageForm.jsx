...
function ModernWeatherForecastTallandBarLanguageForm({ card, onSwitchToSettings, appName, forecastLocation, backgroundColor, textColor, backgroundImage, textFont, language, setLanguage, languageLabels, setLanguageLabels }) {
    ...
    return (
        <div style={styles.container}>
            ...
            <div style={styles.left}>
                ...
                <p>Configure language settings and customize weather-related labels for the horizontal layout forecast widget.</p>
            </div>
...
export default ModernWeatherForecastTallandBarLanguageForm;
