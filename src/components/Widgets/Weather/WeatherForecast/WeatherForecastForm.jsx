...
function WeatherForecastForm({ card, onSwitchToLanguage, appName, setAppName, tags, setTags, forecastLocation, setForecastLocation, backgroundColor, setBackgroundColor, textColor, setTextColor, backgroundImage, setBackgroundImage, textFont, setTextFont, language, setLanguage, languageLabels, setLanguageLabels }) {
    // Fields
