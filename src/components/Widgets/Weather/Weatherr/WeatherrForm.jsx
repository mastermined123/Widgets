...
function WeatherrForm({ card, onSwitchToLanguage, appName, setAppName, tags, setTags, forecastLocation, setForecastLocation, backgroundColor, setBackgroundColor, textColor, setTextColor, backgroundImage, setBackgroundImage, textFont, setTextFont, language, setLanguage, languageLabels, setLanguageLabels }) {
    // Fields
                    ...
                    <div style={styles.field}>
                        <div style={styles.checkboxContainer}>
                            <input
                                ...
                                style={styles.checkbox} />
                            <label>Disable background gradient</label>
                        </div>
                    </div>
