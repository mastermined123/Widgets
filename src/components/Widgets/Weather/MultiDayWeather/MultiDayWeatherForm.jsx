...
function MultiDayWeatherForm({ card, onSwitchToLanguage, appName, setAppName, tags, setTags, forecastLocation, setForecastLocation, backgroundColor, setBackgroundColor, textColor, setTextColor, backgroundImage, setBackgroundImage, textFont, setTextFont, language, setLanguage, languageLabels, setLanguageLabels }) {
    // Fields
    const [dataFeed, setDataFeed] = useState(""); // input for tags

    const [locationName, setLocationName] = useState("");
    const [usePlayerLocation, setUsePlayerLocation] = useState(false);
    const [forecastSpan, setForecastSpan] = useState("Today Only");
    ...
    return (
        <div style={styles.container}>
            ...
            <div style={styles.left}>
                ...
                <p>Configurable multi-day weather forecast widget with location, forecast span, temperature scale, fonts, and styling options.</p>
            </div>
            ...
            <div style={styles.right}>
                ...
                <div style={styles.tabContent}>
                    ...
                    {/* Forecast Span */}
                    <div style={styles.field}>
                        <label>Forecast Span</label>
                        <select
                            value={forecastSpan}
                            onChange={(e) => setForecastSpan(e.target.value)}
                            style={styles.input}
                        >
                            {forecastSpanOptions.map((option, index) => (
...
export default MultiDayWeatherForm;
