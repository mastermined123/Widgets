...
import WeatherForecastTallandBarForm from "./WeatherForecastTallandBarForm";
import WeatherForecastTallandBarLanguageForm from "./WeatherForecastTallandBarLanguageForm";

function WeatherForecastTallandBarMain({ card }) {
    ...
    return (
        <div style={styles.container}>
            {currentView === "settings" ? (
                ...
                <WeatherForecastTallandBarLanguageForm 
                    card={card} 
...
export default WeatherForecastTallandBarMain;
