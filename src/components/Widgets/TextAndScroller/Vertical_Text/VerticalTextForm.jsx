...
import VerticalTextPopUp from "./VerticalTextPopup";

const VerticalTextForm = ({ card }) => {
    ...
    <div style={styles.container}>
      ...
      <div style={styles.right}>
        <div style={styles.tabs}>
          <button style={styles.activeTab}>Settings</button>
        </div>
...
export default VerticalTextForm;
